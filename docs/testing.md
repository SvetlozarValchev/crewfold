...
| `M22-GROUP-01` | owner creates workstreams and places roots/children | grouping is derived from canonical Objective membership, hierarchy remains acyclic, and `default` changes navigation only—not rank or authority |
