...
type daemonClient interface {
	...
	ContextRefresh(context.Context, localapi.ContextRefreshParams) (localapi.ContextRefreshResult, error)
	ContextDeltaList(context.Context, localapi.ContextDeltaListParams) (localapi.ContextDeltaListResult, error)
	ContextDeltaShow(context.Context, string, string) (localapi.ContextDeltaShowResult, error)
	ContextDeltaExplain(context.Context, string, string) (localapi.ContextDeltaExplainResult, error)
