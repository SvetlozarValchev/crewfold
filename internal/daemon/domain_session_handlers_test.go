...
func (fixture *codexDomainSessionFixture) sawArbitraryAgentInstructions() bool {
	...
	expectedTools := []string{domainToolContext, domainToolSendMessage, domainToolAcknowledge, domainToolCreateChild, domainToolDelegateStaffing, domainToolProposeWork, domainToolProposeKnowledge, domainToolControlService, domainToolInspectService, domainToolProposeService, domainToolRequestService, domainToolDelegateService}
