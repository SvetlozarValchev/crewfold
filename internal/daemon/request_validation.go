...
var operatorRequestParamContracts = map[string]string{
	...
	localapi.MethodDomainWorkProposalList:         "local/v1/domain-work-proposal-list.params.schema.json",
	localapi.MethodDomainWorkProposalAccept:       "local/v1/domain-work-proposal-decision.params.schema.json",
	localapi.MethodDomainWorkProposalReject:       "local/v1/domain-work-proposal-decision.params.schema.json",
	...
	localapi.MethodManagedServiceDefinitionCreate: "local/v1/managed-service-definition-create.params.schema.json",
	localapi.MethodManagedServiceDefinitionRetire: "local/v1/managed-service-definition-retire.params.schema.json",
	localapi.MethodManagedServiceDefinitionShow:   "local/v1/managed-service-definition-query.params.schema.json",
	localapi.MethodManagedServiceDefinitionList:   "local/v1/managed-service-definition-query.params.schema.json",
	localapi.MethodManagedServiceStart:            "local/v1/managed-service-start.params.schema.json",
	localapi.MethodManagedServiceShow:             "local/v1/managed-service-query.params.schema.json",
	localapi.MethodManagedServiceList:             "local/v1/managed-service-query.params.schema.json",
	localapi.MethodManagedServiceStop:             "local/v1/managed-service-action.params.schema.json",
	localapi.MethodManagedServiceRestart:          "local/v1/managed-service-action.params.schema.json",
	localapi.MethodManagedServiceResolveUnknown:   "local/v1/managed-service-resolve-unknown.params.schema.json",
	localapi.MethodManagedServiceLogs:             "local/v1/managed-service-logs.params.schema.json",
	localapi.MethodManagedServiceGrantCreate:      "local/v1/managed-service-grant-create.params.schema.json",
	localapi.MethodManagedServiceGrantRevoke:      "local/v1/managed-service-grant-revoke.params.schema.json",
	localapi.MethodManagedServiceGrantList:        "local/v1/managed-service-grant-query.params.schema.json",
	localapi.MethodManagedServiceRequestList:      "local/v1/managed-service-request-query.params.schema.json",
	localapi.MethodManagedServiceRequestAccept:    "local/v1/managed-service-request-decision.params.schema.json",
	localapi.MethodManagedServiceRequestReject:    "local/v1/managed-service-request-decision.params.schema.json",
	localapi.MethodWorkstreamDeliveryShow:         "local/v1/workstream-delivery-query.params.schema.json",
	localapi.MethodWorkstreamDeliveryAccept:       "local/v1/workstream-delivery-decision.params.schema.json",
	localapi.MethodWorkstreamDeliveryReject:       "local/v1/workstream-delivery-decision.params.schema.json",
}
