...
func KnownEventType(value string) bool {
	...
	case
		...
		"domain.staffing_grant_created", "domain.staffing_grant_delegated", "domain.staffing_grant_revoked", "domain.child_created",
		"domain.work_proposal_submitted", "domain.work_proposal_accepted", "domain.work_proposal_rejected", "domain.work_proposal_stale",
		"objective.created", "objective.updated",
		...
		"service.definition_created", "service.definition_retired", "service.start_requested", "service.starting",
		"service.started", "service.health_changed", "service.restart_requested", "service.stop_requested", "service.stopped", "service.failed", "service.runtime_unknown",
		"service.grant_created", "service.grant_delegated", "service.grant_revoked",
		"service.request_created", "service.request_accepted", "service.request_rejected",
