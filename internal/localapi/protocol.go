...
const (
	...
	MethodDomainAgentCreate           = "domain.agent.create"
	MethodDomainAgentSpecDraft        = "domain.agent.spec.draft"
	MethodDomainAgentAttach           = "domain.agent.attach"
	MethodDomainAgentUpdate           = "domain.agent.update"
	MethodDomainAgentTree             = "domain.agent.tree"
	MethodDomainAgentSessionOpen      = "domain.agent.session.open"
	...
	MethodDomainWorkProposalList      = "domain.work_proposal.list"
	MethodDomainWorkProposalAccept    = "domain.work_proposal.accept"
	MethodDomainWorkProposalReject    = "domain.work_proposal.reject"
	...
	DomainAgentCreateSchema           = "urn:crewfold:schema:local-api:domain-agent-create-result:v1"
	DomainAgentSpecDraftSchema        = "urn:crewfold:schema:local-api:domain-agent-spec-draft-result:v1"
	DomainAgentMutationSchema         = "urn:crewfold:schema:local-api:domain-agent-mutation-result:v1"
	DomainAgentTreeSchema             = "urn:crewfold:schema:local-api:domain-agent-tree-result:v1"
	DomainAgentSessionSchema          = "urn:crewfold:schema:local-api:domain-agent-session-result:v1"
	DomainStaffingGrantMutationSchema = "urn:crewfold:schema:local-api:domain-staffing-grant-mutation-result:v1"
	DomainStaffingGrantListSchema     = "urn:crewfold:schema:local-api:domain-staffing-grant-list-result:v1"
	DomainWorkProposalListSchema      = "urn:crewfold:schema:local-api:domain-work-proposal-list-result:v1"
	DomainWorkProposalDecisionSchema  = "urn:crewfold:schema:local-api:domain-work-proposal-decision-result:v1"
