...
await waitFor("document.querySelector('.inspector')?.textContent.includes('Independently review the M23 delivery') && document.querySelector('.inspector')?.textContent.includes('CHANGES REQUESTED') && document.querySelector('.inspector')?.textContent.includes('Next owner') && document.querySelector('.inspector')?.textContent.includes('m23-remediator') && !document.querySelector('.inspector')?.textContent.includes('Retry rejected completion')", "review findings routed to the exact remediation owner");
