...
grep -Fq '"hierarchyExact": true' "$scenario_root/browser-result.json"
grep -Fq '"taskInDurableSession": true' "$scenario_root/browser-result.json"
grep -Fq '"ownerSteeredSameSession": true' "$scenario_root/browser-result.json"
