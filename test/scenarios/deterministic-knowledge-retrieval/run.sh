...
"$binary" events list --after 0 --limit 1000 --socket "$socket_path" --output json >"$scenario_root/events-baseline.json"
...
"$binary" events list --after 0 --limit 1000 --socket "$socket_path" --output json >"$scenario_root/events-after-search.json"
...
"$binary" events list --after 0 --limit 1000 --socket "$socket_path" --output json >"$scenario_root/events-mismatch.json"
...
"$binary" events list --after 0 --limit 1000 --socket "$socket_path" --output json >"$scenario_root/events-degraded.json"
...
"$binary" events list --after 0 --limit 1000 --socket "$socket_path" --output json >"$scenario_root/events-repaired.json"
