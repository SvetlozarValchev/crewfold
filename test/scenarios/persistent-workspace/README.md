# Persistent workspace acceptance scenario

This black-box scenario proves the persistent workspace and event journal with
...
```sh
./test/scenarios/persistent-workspace/run.sh
```
