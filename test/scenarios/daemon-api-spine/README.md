# Daemon API spine acceptance scenario

This black-box scenario proves the daemon and local API spine using the real
...
```sh
./test/scenarios/daemon-api-spine/run.sh
```
